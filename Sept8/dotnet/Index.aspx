...
<body>
    ...
    <tr><td>
       <input type="text" name="username" class="username" /></td><td>
            <input type="password" name="password" class="password" />
            <input type="submit" id="login" value="login" onclick="return login_onclick()" /></td></tr>
                <tr><td>
    ...
    <td><table width="60%" cellspacing="10%"><h1>Create an account</h1>
    ...
    <tr><td>
      <input type="text" placeholder="First name" />
        ...
        <input  type="text" placeholder="Surname" />
            ...
            <tr> <td>
               <input type="text" placeholder="email or Phone" style="width:318px;" /></td></tr>
               
                    <tr><td>
                       <input type="password" placeholder="password" style="width:318px;" /></td></tr>
                    <tr><td><label>Birthday</label></td></tr><td></td>
                    <tr><td><select><option>Day</option></select><select><option>Month</option></select><select><option>Year</option></select>why do i provied my birthday</td>
                    <tr><td>
